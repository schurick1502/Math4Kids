...
Hauptmenü: Klassenstufen-Auswahl + Settings-Button + Install-Button (wenn verfügbar)
Spielbildschirm: Leben, Timer, Frage-Nr, Aufgabe, Eingabefeld, Submit-Button, Fortschrittsbalken
Einstellungen: Belohnungen verwalten + Strafaufgaben verwalten
Ergebnis: Statistik, Prozent, Belohnung/Strafe anzeigen, Nochmal-Button
...
bashnpm create vite@latest kopfrechnen-pwa -- --template react
cd kopfrechnen-pwa
npm install
...
Konfiguriere Tailwind CSS in tailwind.config.js
Erstelle alle Komponenten und Dateien
Teste lokal: npm run dev
Baue für Produktion: npm run build
Deploye auf GitHub Pages, Netlify oder Vercel
...
LocalStorage persistence (App neu laden)
